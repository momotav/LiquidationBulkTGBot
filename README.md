...
- 💾 **Persistent storage** - PostgreSQL keeps subscribers across restarts
...
4. Railway **automatically** sets `DATABASE_URL` - no manual config needed!

### Step 5: Add Bot Token
...
```
┌─────────────────┐     ┌──────────────────┐     ┌─────────────────┐
│  BULK Exchange  │────▶│   Your Bot       │────▶│   Telegram      │
│  WebSocket      │     │   (Railway)      │     │   Users         │
└─────────────────┘     └────────┬─────────┘     └─────────────────┘
                                 │
                        ┌────────▼─────────┐
                        │   PostgreSQL     │
